...
import org.sqljsonquery.dbmd.RelMetadata.RelType;
import static org.sqljsonquery.dbmd.RelMetadata.RelType.Table;
import static org.sqljsonquery.dbmd.RelMetadata.RelType.View;
       ...
       throws SQLException
    {
        try ( ResultSet pkRS = dbmd.getPrimaryKeys(colsRS.getString(1), colsRS.getString(2), colsRS.getString(3)) )
        {
            ...
            Optional<Boolean> nullable = getRSInt(colsRS, "NULLABLE").flatMap(n ->
                n == ResultSetMetaData.columnNullable ? opt(true) :
                n == ResultSetMetaData.columnNoNulls ? opt(false) :
                    empty()
            );
