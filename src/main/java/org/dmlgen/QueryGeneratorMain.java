...
import org.dmlgen.util.AppUtils.SplitArgs;
import org.dmlgen.util.Pair;
import static org.dmlgen.util.AppUtils.splitOptionsAndRequiredArgs;
import static org.dmlgen.util.AppUtils.throwError;
import static org.dmlgen.util.Files.readString;
import static org.dmlgen.util.Optionals.opt;
import static org.dmlgen.util.Files.newFileOrStdoutWriter;
import org.dmlgen.dbmd.DatabaseMetadata;
import org.dmlgen.specs.queries.QueryGroupSpec;
import org.dmlgen.specs.queries.ResultsRepr;
import org.dmlgen.result_types.SourceCodeWriter;
import org.dmlgen.result_types.source_writers.JavaWriter;
import org.dmlgen.result_types.source_writers.TypescriptWriter;
import static org.dmlgen.result_types.source_writers.JavaWriter.NullableFieldRepr;
