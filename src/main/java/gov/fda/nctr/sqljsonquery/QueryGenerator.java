...
import static gov.fda.nctr.util.CollFuns.*;
...
import gov.fda.nctr.sqljsonquery.spec.TableOutputSpec;
import gov.fda.nctr.sqljsonquery.spec.QueriesSpec;
import gov.fda.nctr.sqljsonquery.spec.QuerySpec;
import gov.fda.nctr.sqljsonquery.spec.TableOutputField;
import gov.fda.nctr.sqljsonquery.spec.ChildTableSpec;
import gov.fda.nctr.sqljsonquery.spec.ParentTableSpec;
import gov.fda.nctr.sqljsonquery.sql.ChildFkCondition;
import gov.fda.nctr.sqljsonquery.sql.ParentChildCondition;
import gov.fda.nctr.sqljsonquery.sql.ParentPkCondition;
import gov.fda.nctr.sqljsonquery.sql.SqlQueryParts;
import gov.fda.nctr.sqljsonquery.sql.dialect.OracleDialect;
import gov.fda.nctr.sqljsonquery.sql.dialect.PostgresDialect;
import gov.fda.nctr.sqljsonquery.sql.dialect.SqlDialect;
   ...
   private SqlJsonQuery makeSqlJsonQuery(QuerySpec querySpec)
   {
      ...
      List<GeneratedType> generatedTypes =
         querySpec.getGenerateResultTypes() ?
            typesGenerator.makeResultTypeDefinitions(querySpec.getTableOutputSpec())
            : emptyList();
